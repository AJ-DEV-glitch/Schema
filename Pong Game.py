# Pip install turtle libabry
import turtle as t
import os
playerAscore = 0
playerBscore = 0

#create a windoe and declare a variable to call the window
window = t.Screen()
...
# code for creating the pen for scorecard update
pen = t.Turtle()
pen.speed(0)
pen.color("Blue")
pen.penup()
...
# code ofr moving the left paddle
def leftpaddleup():
    y = leftpaddle.ycor()
    y = y + 90
    leftpaddle.sety(y)
